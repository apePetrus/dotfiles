...
static const char *fonts[]          = {"CaskaydiaMono:style:medium:size=12" ,"CaskaydiaMono Nerd Font Mono:style:medium:size=19" };
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_e,      spawn,          SHCMD("~/.scripts/prompt 'Do you really want to quit?' 'killall bar.sh chadwm'") },
