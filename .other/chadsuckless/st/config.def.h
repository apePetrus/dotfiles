 ...
 */
static char *font = "CaskaydiaMono Nerd Font :pixelsize=15:antialias=true:autohint=true";
static char *font2[] = { "CaskaydiaMono Nerd Font :pixelsize=15:antialias=true:autohint=true" };
